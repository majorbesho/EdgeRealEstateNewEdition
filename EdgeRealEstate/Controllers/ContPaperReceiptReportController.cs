...
{
    public class ContPaperReceiptReportController : Controller
    {
        // GET: ContPaperReceiptReport
        ApplicationDbContext db = new ApplicationDbContext();
        private ContPaperReceiptReportService ContPaperReceiptReportService;
        public ContPaperReceiptReportController()
        {
            this.ContPaperReceiptReportService = new ContPaperReceiptReportService(db);
        }
            ...
            )
        {
            ...
            return Json(ContPaperReceiptReportService.Read(FromDate, toDate
        ...
        public ActionResult Download_PDF(DateTime? FromDate, DateTime? toDate)
        {
            ...
            rd.Load(Path.Combine(Server.MapPath("~/Reports"), "ContPaperReceiptReport.rpt"));
            if (FromDate == null)
            {
            ...
            return File(stream, "application/pdf", "ContPaperReceiptReport.pdf");
        }
