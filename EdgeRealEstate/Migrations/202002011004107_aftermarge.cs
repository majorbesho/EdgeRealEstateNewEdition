namespace EdgeRealEstate.Migrations
{
    ...
    public partial class aftermarge : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Dbtpaid = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Dbtnotes = c.String(),
                        refID = c.Int(nullable: false),
                        paidMethod = c.String(),
                        ContPaperPaymentType = c.String(),
                        salesManId = c.Int(nullable: false),
                        Dbtindate = c.DateTime(nullable: false),
                        empId = c.Int(nullable: false),
                        hashCol = c.String(),
                        isDeleted = c.Boolean(nullable: false),
                        billId = c.Int(nullable: false),
                        ProjectId = c.Int(),
                        DbtrefType = c.Int(nullable: false),
                        Employee_Id = c.Int(),
                        Employee1_Id = c.Int(),
                        Employee_Id1 = c.Int(),
                        Employee_Id2 = c.Int(),
            ...
            CreateTable(
                ...
                c => new
                    {
                        id = c.Int(nullable: false, identity: true),
                        ContributorId = c.Int(nullable: false),
                        Crdpaid = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Crdnotes = c.String(),
                        refID = c.Int(nullable: false),
                        paidMethod = c.String(),
                        ContPaperReceiptType = c.String(),
                        salesManId = c.Int(nullable: false),
                        Crdindate = c.DateTime(nullable: false),
                        empId = c.Int(nullable: false),
                        hashCol = c.String(),
                        isDeleted = c.Boolean(nullable: false),
                        billId = c.Int(nullable: false),
                        ProjectId = c.Int(),
                        CrdrefType = c.Int(nullable: false),
                        Employee_Id = c.Int(),
                        Employee1_Id = c.Int(),
                        Employee_Id1 = c.Int(),
                        Employee_Id2 = c.Int(),
                ...
                .ForeignKey("dbo.Employees", t => t.Employee1_Id)
                .ForeignKey("dbo.Project", t => t.ProjectId)
                .ForeignKey("dbo.LKRefTypes", t => t.CrdrefType)
                .ForeignKey("dbo.Employees", t => t.Employee_Id1)
                .ForeignKey("dbo.Employees", t => t.Employee_Id2)
                .Index(t => t.ContributorId)
                .Index(t => t.ProjectId)
                .Index(t => t.CrdrefType)
                .Index(t => t.Employee_Id)
                .Index(t => t.Employee1_Id)
                .Index(t => t.Employee_Id1)
                .Index(t => t.Employee_Id2);
                ...
                c => new
                    {
                        ...
                        refTypeCreditID = c.Int(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ContPaperPayments", "DbtrefType", "dbo.LKRefTypes");
            ...
            DropForeignKey("dbo.ContPaperReceipts", "CrdrefType", "dbo.LKRefTypes");
