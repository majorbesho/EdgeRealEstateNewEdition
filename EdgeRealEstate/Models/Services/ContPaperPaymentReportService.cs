...
{
    public class ContPaperPaymentReportService
    {
        private static bool UpdateDatabase = true;
        private ApplicationDbContext db;

        public ContPaperPaymentReportService(ApplicationDbContext db)
        {
            this.db = db;
        }

        public IList<ContPaperPaymentViewModel> GetAll(
            //int? FromCust, int? toCust, int? FromSalesMan, int? toSalesMan,
            DateTime? FromDate, DateTime? toDate
           )
        {
            DateTime vFromDate = new DateTime(DateTime.Now.Year, 1, 1);
            var result = HttpContext.Current.Session["CustomerMove"] as IList<ContPaperPaymentViewModel>;
        ...
        public IEnumerable<ContPaperPaymentViewModel> Read(DateTime? FromDate, DateTime? toDate
